  ...
  return (
    <DrawerPortal data-slot="drawer-portal">
      ...
      <DrawerPrimitive.Content
        ...
        className={cn(
          "group/drawer-content fixed z-50 flex h-auto flex-col shadow-lg",
        ...
        style={{
          ...
          boxShadow: "0 4px 6px var(--velour-shadow)",
        }}
        {...props}
      >
...
function DrawerHeader({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "flex w-full flex-col gap-1 rounded-t-lg border-b px-4 py-2 md:mx-auto md:max-w-md",
        className,
      )}
      style={{
